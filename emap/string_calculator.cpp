...
void countLetters()
{
	...
	for (char letter : str)
	{
		...
		if (
			...
			||
			(letter == 'А') || (letter == 'Е') || (letter == 'Ё') || (letter == 'И') || (letter == 'І') ||
			(letter == 'О') || (letter == 'У') || (letter == 'Ы') || (letter == 'Э') || (letter == 'Ю') ||
			(letter == 'Я') || (letter == 'ё') || (letter == 'і') || (letter == 'о')
			)
		{
			nVowels++;
		}
			...
			if (
				...
				(letter == 'Ц') || (letter == 'Ч') || (letter == 'Ш') || (letter == 'Щ') || (letter == 'Ъ') || (letter == 'Ь')
				||
				(letter == 'ў')
				) 
			{
